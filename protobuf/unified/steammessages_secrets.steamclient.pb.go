...
func (EKeyEscrowUsage) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_steammessages_secrets_steamclient_9bb57ca37fe12c50, []int{0}
}
...
func (*CKeyEscrow_Ticket) Descriptor() ([]byte, []int) {
	return fileDescriptor_steammessages_secrets_steamclient_9bb57ca37fe12c50, []int{1}
}
...
func (*CKeyEscrow_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_steammessages_secrets_steamclient_9bb57ca37fe12c50, []int{2}
}
...
func init() {
	proto.RegisterFile("steammessages_secrets.steamclient.proto", fileDescriptor_steammessages_secrets_steamclient_9bb57ca37fe12c50)
}

var fileDescriptor_steammessages_secrets_steamclient_9bb57ca37fe12c50 = []byte{
