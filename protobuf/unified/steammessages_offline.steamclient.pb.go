...
func (*COffline_OfflineLogonTicket) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{3} }
...
func init() { proto.RegisterFile("steammessages_offline.steamclient.proto", fileDescriptor10) }
