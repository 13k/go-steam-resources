...
func (EProtoExecutionSite) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_steammessages_unified_base_steamclient_7e3a829c4ee12810, []int{0}
}
...
func init() {
	proto.RegisterFile("steammessages_unified_base.steamclient.proto", fileDescriptor_steammessages_unified_base_steamclient_7e3a829c4ee12810)
}

var fileDescriptor_steammessages_unified_base_steamclient_7e3a829c4ee12810 = []byte{
