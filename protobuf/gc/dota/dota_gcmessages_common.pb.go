...
type CSODOTAParty struct {
	...
	ActiveIngameEvents              []EIngameEvent        `protobuf:"varint,39,rep,name=active_ingame_events,enum=EIngameEvent" json:"active_ingame_events,omitempty"`
...
type CSODOTALobby struct {
	...
	ActiveIngameEvents         []EIngameEvent                       `protobuf:"varint,69,rep,name=active_ingame_events,enum=EIngameEvent" json:"active_ingame_events,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("EIngameEvent", EIngameEvent_name, EIngameEvent_value)
