...
func (ENetworkDisconnectionReason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_network_connection_c0ba055edf5e5a83, []int{0}
}
...
func init() {
	proto.RegisterFile("network_connection.proto", fileDescriptor_network_connection_c0ba055edf5e5a83)
}

var fileDescriptor_network_connection_c0ba055edf5e5a83 = []byte{
