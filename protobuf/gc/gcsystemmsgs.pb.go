...
func (EGCSystemMsg) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (ESOMsg) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (EGCBaseClientMsg) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (EGCToGCMsg) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func init() { proto.RegisterFile("gcsystemmsgs.proto", fileDescriptor1) }
