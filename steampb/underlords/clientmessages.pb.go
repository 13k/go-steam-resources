...
// 	protoc        v3.11.2
// source: underlords/clientmessages.proto
...
func (EBaseClientMessages) Descriptor() protoreflect.EnumDescriptor {
	return file_underlords_clientmessages_proto_enumTypes[0].Descriptor()
}

func (EBaseClientMessages) Type() protoreflect.EnumType {
	return &file_underlords_clientmessages_proto_enumTypes[0]
}
...
func (EBaseClientMessages) EnumDescriptor() ([]byte, []int) {
	return file_underlords_clientmessages_proto_rawDescGZIP(), []int{0}
}
...
func (EClientUIEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_underlords_clientmessages_proto_enumTypes[1].Descriptor()
}

func (EClientUIEvent) Type() protoreflect.EnumType {
	return &file_underlords_clientmessages_proto_enumTypes[1]
}
...
func (EClientUIEvent) EnumDescriptor() ([]byte, []int) {
	return file_underlords_clientmessages_proto_rawDescGZIP(), []int{1}
}
...
func (x *CClientMsg_CustomGameEvent) Reset() {
	*x = CClientMsg_CustomGameEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_underlords_clientmessages_proto_msgTypes[0]
...
func (x *CClientMsg_CustomGameEventBounce) Reset() {
	*x = CClientMsg_CustomGameEventBounce{}
	if protoimpl.UnsafeEnabled {
		mi := &file_underlords_clientmessages_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type CClientMsg_ClientUIEvent struct {
	...
	Event         *EClientUIEvent `protobuf:"varint,1,opt,name=event,enum=underlords.EClientUIEvent,def=0" json:"event,omitempty"`
...
func (x *CClientMsg_ClientUIEvent) Reset() {
	*x = CClientMsg_ClientUIEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_underlords_clientmessages_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_ClientUIEvent) Descriptor() ([]byte, []int) {
	return file_underlords_clientmessages_proto_rawDescGZIP(), []int{2}
}
...
func (x *CClientMsg_DevPaletteVisibilityChangedEvent) Reset() {
	*x = CClientMsg_DevPaletteVisibilityChangedEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_underlords_clientmessages_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_DevPaletteVisibilityChangedEvent) Descriptor() ([]byte, []int) {
	return file_underlords_clientmessages_proto_rawDescGZIP(), []int{3}
}
...
func (x *CClientMsg_WorldUIControllerHasPanelChangedEvent) Reset() {
	*x = CClientMsg_WorldUIControllerHasPanelChangedEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_underlords_clientmessages_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_WorldUIControllerHasPanelChangedEvent) Descriptor() ([]byte, []int) {
	return file_underlords_clientmessages_proto_rawDescGZIP(), []int{4}
}
...
func (x *CClientMsg_RotateAnchor) Reset() {
	*x = CClientMsg_RotateAnchor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_underlords_clientmessages_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_RotateAnchor) Descriptor() ([]byte, []int) {
	return file_underlords_clientmessages_proto_rawDescGZIP(), []int{5}
}
...
var File_underlords_clientmessages_proto protoreflect.FileDescriptor

var file_underlords_clientmessages_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x6c, 0x6f, 0x72, 0x64, 0x73, 0x2f, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x0a, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x6c, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x4f, 0x0a,
	0x1a, 0x43, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4d, 0x73, 0x67, 0x5f, 0x43, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x47, 0x61, 0x6d, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x65,
	...
	0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x78,
	0x0a, 0x20, 0x43, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4d, 0x73, 0x67, 0x5f, 0x43, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x47, 0x61, 0x6d, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x6f, 0x75, 0x6e,
	0x63, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xd8, 0x01, 0x0a, 0x18, 0x43, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x4d, 0x73, 0x67, 0x5f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x49,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x48, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x75, 0x6e, 0x64, 0x65, 0x72, 0x6c, 0x6f, 0x72, 0x64,
	0x73, 0x2e, 0x45, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x49, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x42, 0x3b, 0x48, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var (
	file_underlords_clientmessages_proto_rawDescOnce sync.Once
	file_underlords_clientmessages_proto_rawDescData = file_underlords_clientmessages_proto_rawDesc
)

func file_underlords_clientmessages_proto_rawDescGZIP() []byte {
	file_underlords_clientmessages_proto_rawDescOnce.Do(func() {
		file_underlords_clientmessages_proto_rawDescData = protoimpl.X.CompressGZIP(file_underlords_clientmessages_proto_rawDescData)
	})
	return file_underlords_clientmessages_proto_rawDescData
}

var file_underlords_clientmessages_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_underlords_clientmessages_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_underlords_clientmessages_proto_goTypes = []interface{}{
	(EBaseClientMessages)(0),                                 // 0: underlords.EBaseClientMessages
	(EClientUIEvent)(0),                                      // 1: underlords.EClientUIEvent
	(*CClientMsg_CustomGameEvent)(nil),                       // 2: underlords.CClientMsg_CustomGameEvent
	(*CClientMsg_CustomGameEventBounce)(nil),                 // 3: underlords.CClientMsg_CustomGameEventBounce
	(*CClientMsg_ClientUIEvent)(nil),                         // 4: underlords.CClientMsg_ClientUIEvent
	(*CClientMsg_DevPaletteVisibilityChangedEvent)(nil),      // 5: underlords.CClientMsg_DevPaletteVisibilityChangedEvent
	(*CClientMsg_WorldUIControllerHasPanelChangedEvent)(nil), // 6: underlords.CClientMsg_WorldUIControllerHasPanelChangedEvent
	(*CClientMsg_RotateAnchor)(nil),                          // 7: underlords.CClientMsg_RotateAnchor
}
var file_underlords_clientmessages_proto_depIdxs = []int32{
	1, // 0: underlords.CClientMsg_ClientUIEvent.event:type_name -> underlords.EClientUIEvent
...
func init() { file_underlords_clientmessages_proto_init() }
func file_underlords_clientmessages_proto_init() {
	if File_underlords_clientmessages_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_underlords_clientmessages_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_underlords_clientmessages_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_underlords_clientmessages_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_underlords_clientmessages_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_underlords_clientmessages_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_underlords_clientmessages_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_underlords_clientmessages_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_underlords_clientmessages_proto_goTypes,
		DependencyIndexes: file_underlords_clientmessages_proto_depIdxs,
		EnumInfos:         file_underlords_clientmessages_proto_enumTypes,
		MessageInfos:      file_underlords_clientmessages_proto_msgTypes,
	}.Build()
	File_underlords_clientmessages_proto = out.File
	file_underlords_clientmessages_proto_rawDesc = nil
	file_underlords_clientmessages_proto_goTypes = nil
	file_underlords_clientmessages_proto_depIdxs = nil
}
