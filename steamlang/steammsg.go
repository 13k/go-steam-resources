...
func (m *UdpHeader) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Magic); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.PayloadSize); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.PacketType); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Flags); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SourceConnID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.DestConnID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SeqThis); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SeqAck); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.PacketsInMsg); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.MsgStartSeq); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.MsgSize); err != nil { return }
	return
}

func (m *UdpHeader) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Magic); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.PayloadSize); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.PacketType); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Flags); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SourceConnID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.DestConnID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SeqThis); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SeqAck); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.PacketsInMsg); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.MsgStartSeq); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.MsgSize); err != nil { return }
	return
}
...
func (m *ChallengeData) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.ChallengeValue); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ServerLoad); err != nil { return }
	return
}

func (m *ChallengeData) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.ChallengeValue); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ServerLoad); err != nil { return }
	return
}
...
func (m *MsgHdr) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Msg); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.TargetJobID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SourceJobID); err != nil { return }
	return
}

func (m *MsgHdr) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Msg); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.TargetJobID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SourceJobID); err != nil { return }
	return
}
...
func (m *ExtendedClientMsgHdr) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Msg); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.HeaderSize); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.HeaderVersion); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.TargetJobID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SourceJobID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.HeaderCanary); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SessionID); err != nil { return }
	return
}

func (m *ExtendedClientMsgHdr) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Msg); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.HeaderSize); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.HeaderVersion); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.TargetJobID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SourceJobID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.HeaderCanary); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SessionID); err != nil { return }
	return
}
...
func (m *MsgHdrProtoBuf) Serialize(w io.Writer) (err error) {
	...
	if err = binary.Write(w, binary.LittleEndian, data0); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.HeaderLength); err != nil { return }
	var data2 []byte
	if data2, err = proto.Marshal(m.Proto); err != nil { return }
	m.HeaderLength = int32(len(data2))
	if _, err = w.Write(data2); err != nil { return }
	return
}

func (m *MsgHdrProtoBuf) Deserialize(r io.Reader) (err error) {
	var data0 uint32
	if err = binary.Read(r, binary.LittleEndian, &data0); err != nil { return }
	m.Msg = MakeEMsg(data0)
	if err = binary.Read(r, binary.LittleEndian, &m.HeaderLength); err != nil { return }
	data2 := make([]byte, m.HeaderLength, m.HeaderLength)
	if _, err = io.ReadFull(r, data2); err != nil { return }
	if err = proto.Unmarshal(data2, m.Proto); err != nil { return }
	return
}
...
func (m *MsgClientGenericResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	return
}

func (m *MsgClientGenericResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	return
}
...
func (m *MsgChannelEncryptRequest) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.ProtocolVersion); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Universe); err != nil { return }
	return
}

func (m *MsgChannelEncryptRequest) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.ProtocolVersion); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Universe); err != nil { return }
	return
}
...
func (m *MsgChannelEncryptResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.ProtocolVersion); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.KeySize); err != nil { return }
	return
}

func (m *MsgChannelEncryptResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.ProtocolVersion); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.KeySize); err != nil { return }
	return
}
...
func (m *MsgClientNewLoginKey) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.UniqueID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.LoginKey); err != nil { return }
	return
}

func (m *MsgClientNewLoginKey) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.UniqueID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.LoginKey); err != nil { return }
	return
}
...
func (m *MsgClientVACBanStatus) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.NumBans); err != nil { return }
	return
}

func (m *MsgClientVACBanStatus) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.NumBans); err != nil { return }
	return
}
...
func (m *MsgClientAppUsageEvent) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.AppUsageEvent); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.GameID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Offline); err != nil { return }
	return
}

func (m *MsgClientAppUsageEvent) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.AppUsageEvent); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.GameID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Offline); err != nil { return }
	return
}
...
func (m *MsgClientEmailAddrInfo) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.PasswordStrength); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.FlagsAccountSecurityPolicy); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Validated); err != nil { return }
	return
}

func (m *MsgClientEmailAddrInfo) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.PasswordStrength); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.FlagsAccountSecurityPolicy); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Validated); err != nil { return }
	return
}
...
func (m *MsgClientUpdateGuestPassesList) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.CountGuestPassesToGive); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.CountGuestPassesToRedeem); err != nil { return }
	return
}

func (m *MsgClientUpdateGuestPassesList) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.CountGuestPassesToGive); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.CountGuestPassesToRedeem); err != nil { return }
	return
}
...
func (m *MsgClientRequestedClientStats) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.CountStats); err != nil { return }
	return
}

func (m *MsgClientRequestedClientStats) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.CountStats); err != nil { return }
	return
}
...
func (m *MsgClientP2PIntroducerMessage) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamID); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.RoutingType); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Data); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.DataLen); err != nil { return }
	return
}

func (m *MsgClientP2PIntroducerMessage) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamID); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.RoutingType); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Data); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.DataLen); err != nil { return }
	return
}
...
func (m *MsgClientOGSBeginSession) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.AccountType); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.AccountId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.AppId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.TimeStarted); err != nil { return }
	return
}

func (m *MsgClientOGSBeginSession) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.AccountType); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.AccountId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.AppId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.TimeStarted); err != nil { return }
	return
}
...
func (m *MsgClientOGSBeginSessionResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.CollectingAny); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.CollectingDetails); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SessionId); err != nil { return }
	return
}
...
func (m *MsgClientOGSBeginSessionResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.CollectingAny); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.CollectingDetails); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SessionId); err != nil { return }
	return
}
...
func (m *MsgClientOGSEndSession) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SessionId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.TimeEnded); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ReasonCode); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.CountAttributes); err != nil { return }
	return
}

func (m *MsgClientOGSEndSession) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SessionId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.TimeEnded); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ReasonCode); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.CountAttributes); err != nil { return }
	return
}
...
func (m *MsgClientGetFriendsWhoPlayGameResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.GameId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.CountFriends); err != nil { return }
	return
}
...
func (m *MsgClientGetFriendsWhoPlayGameResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.GameId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.CountFriends); err != nil { return }
	return
}
...
func (m *MsgGSGetPlayStatsResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Rank); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.LifetimeConnects); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.LifetimeMinutesPlayed); err != nil { return }
	return
}

func (m *MsgGSGetPlayStatsResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Rank); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.LifetimeConnects); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.LifetimeMinutesPlayed); err != nil { return }
	return
}
...
func (m *MsgGSGetReputationResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ReputationScore); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Banned); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.BannedIp); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.BannedPort); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.BannedGameId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.TimeBanExpires); err != nil { return }
	return
}

func (m *MsgGSGetReputationResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ReputationScore); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Banned); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.BannedIp); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.BannedPort); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.BannedGameId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.TimeBanExpires); err != nil { return }
	return
}
...
func (m *MsgGSDeny) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.DenyReason); err != nil { return }
	return
}

func (m *MsgGSDeny) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.DenyReason); err != nil { return }
	return
}
...
func (m *MsgGSKick) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.DenyReason); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.WaitTilMapChange); err != nil { return }
	return
}
...
func (m *MsgGSKick) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.DenyReason); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.WaitTilMapChange); err != nil { return }
	return
}
...
func (m *MsgGSGetUserGroupStatus) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdUser); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdGroup); err != nil { return }
	return
}

func (m *MsgGSGetUserGroupStatus) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdUser); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdGroup); err != nil { return }
	return
}
...
func (m *MsgGSGetUserGroupStatusResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdUser); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdGroup); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ClanRelationship); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ClanRank); err != nil { return }
	return
}
...
func (m *MsgGSGetUserGroupStatusResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdUser); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdGroup); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ClanRelationship); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ClanRank); err != nil { return }
	return
}
...
func (m *MsgClientJoinChat) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChat); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.IsVoiceSpeaker); err != nil { return }
	return
}

func (m *MsgClientJoinChat) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChat); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.IsVoiceSpeaker); err != nil { return }
	return
}
...
func (m *MsgClientChatEnter) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChat); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdFriend); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ChatRoomType); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdOwner); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdClan); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ChatFlags); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.EnterResponse); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.NumMembers); err != nil { return }
	return
}

func (m *MsgClientChatEnter) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChat); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdFriend); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ChatRoomType); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdOwner); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdClan); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ChatFlags); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.EnterResponse); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.NumMembers); err != nil { return }
	return
}
...
func (m *MsgClientChatMsg) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChatter); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChatRoom); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ChatMsgType); err != nil { return }
	return
}

func (m *MsgClientChatMsg) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChatter); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChatRoom); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ChatMsgType); err != nil { return }
	return
}
...
func (m *MsgClientChatMemberInfo) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChat); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Type); err != nil { return }
	return
}

func (m *MsgClientChatMemberInfo) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChat); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Type); err != nil { return }
	return
}
...
func (m *MsgClientChatAction) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChat); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdUserToActOn); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ChatAction); err != nil { return }
	return
}

func (m *MsgClientChatAction) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChat); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdUserToActOn); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ChatAction); err != nil { return }
	return
}
...
func (m *MsgClientChatActionResult) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdChat); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdUserActedOn); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ChatAction); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ActionResult); err != nil { return }
	return
}

func (m *MsgClientChatActionResult) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdChat); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdUserActedOn); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ChatAction); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ActionResult); err != nil { return }
	return
}
...
func (m *MsgClientSetIgnoreFriend) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.MySteamId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdFriend); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Ignore); err != nil { return }
	return
}

func (m *MsgClientSetIgnoreFriend) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.MySteamId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdFriend); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Ignore); err != nil { return }
	return
}
...
func (m *MsgClientSetIgnoreFriendResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.FriendId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	return
}

func (m *MsgClientSetIgnoreFriendResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.FriendId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	return
}
...
func (m *MsgClientLoggedOff) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SecMinReconnectHint); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SecMaxReconnectHint); err != nil { return }
	return
}

func (m *MsgClientLoggedOff) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SecMinReconnectHint); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SecMaxReconnectHint); err != nil { return }
	return
}
...
func (m *MsgClientLogOnResponse) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.Result); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.OutOfGameHeartbeatRateSec); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.InGameHeartbeatRateSec); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ClientSuppliedSteamId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.IpPublic); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ServerRealTime); err != nil { return }
	return
}

func (m *MsgClientLogOnResponse) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.Result); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.OutOfGameHeartbeatRateSec); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.InGameHeartbeatRateSec); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ClientSuppliedSteamId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.IpPublic); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ServerRealTime); err != nil { return }
	return
}
...
func (m *MsgClientSendGuestPass) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.GiftId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.GiftType); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.AccountId); err != nil { return }
	return
}

func (m *MsgClientSendGuestPass) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.GiftId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.GiftType); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.AccountId); err != nil { return }
	return
}
...
func (m *MsgClientServerUnavailable) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.JobidSent); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.EMsgSent); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.EServerTypeUnavailable); err != nil { return }
	return
}

func (m *MsgClientServerUnavailable) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.JobidSent); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.EMsgSent); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.EServerTypeUnavailable); err != nil { return }
	return
}
...
func (m *MsgClientCreateChat) Serialize(w io.Writer) (err error) {
	...
	if err = binary.Write(w, binary.LittleEndian, m.GameId); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdClan); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.PermissionOfficer); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.PermissionMember); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.PermissionAll); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.MembersMax); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.ChatFlags); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdFriendChat); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.SteamIdInvited); err != nil { return }
	return
}
...
func (m *MsgClientCreateChat) Deserialize(r io.Reader) (err error) {
	...
	if err = binary.Read(r, binary.LittleEndian, &m.GameId); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdClan); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.PermissionOfficer); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.PermissionMember); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.PermissionAll); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.MembersMax); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.ChatFlags); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdFriendChat); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.SteamIdInvited); err != nil { return }
	return
}
...
func (m *MsgClientMarketingMessageUpdate2) Serialize(w io.Writer) (err error) {
	if err = binary.Write(w, binary.LittleEndian, m.MarketingMessageUpdateTime); err != nil { return }
	if err = binary.Write(w, binary.LittleEndian, m.Count); err != nil { return }
	return
}

func (m *MsgClientMarketingMessageUpdate2) Deserialize(r io.Reader) (err error) {
	if err = binary.Read(r, binary.LittleEndian, &m.MarketingMessageUpdateTime); err != nil { return }
	if err = binary.Read(r, binary.LittleEndian, &m.Count); err != nil { return }
	return
}
